...
public class CountryFlagUtil {
    ...
    // region Constructors
    public CountryFlagUtil() {
    }

//    CountryFlagUtil(Builder builder) {
...
//    }
    ...
    // region Listeners
    void sortCountries(@NonNull List<Country> countries) {
        switch (sortBy) {
            case SORT_BY_NAME:
    ...
    public List<Country> getAllCountries(int sortBy) {
        this.sortBy = sortBy;
        countries = new ArrayList<>(Arrays.asList(COUNTRIES));
        sortCountries(countries);
        return countries;
...
//        }
//
//        public CountryFlagUtil build() {
//            return new CountryFlagUtil(this);
//        }
//    }
    // endregion
